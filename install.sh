...
display() {
    ...
    echo
    echo "$(tput setaf 6)   SENTRY EGG — Secure Universal Installer & Runtime Manager$(tput sgr0)"
    echo "$(tput setaf 3)   Supports: Minecraft (Paper, Purpur), Discord Bots, Python, More$(tput sgr0)"
    echo "$(tput setaf 7)   By SkullyShadow • Sentry-Nodes.org"
    echo
}
...
mkdir -p plugins
curl -s -o plugins/hibernate.jar https://raw.githubusercontent.com/skullyshadow/sentryegg/main/Hibernate-2.1.0.jar
fi
